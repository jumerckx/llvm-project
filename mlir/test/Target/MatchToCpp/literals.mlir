...
module {
  ...
  match.matcher @lit_matcher root(%root : !pdl.operation) {
    ...
    %a1 = match.is_not_null %a0 : !pdl.attribute
  ...
  match.matcher @const_matcher root(%root : !pdl.operation) {
    ...
    %r1 = match.is_not_null %r0 : !pdl.range<value>
    %rt = match.get_value_type of %r1 : !pdl.range<type>
